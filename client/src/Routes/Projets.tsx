    ...
    <Container id="projets" className="mt-5">
      ...
      <div className="mt-5">
        <Row>
          <DetailsProjets
            nom="Ce portfolio"
            images={[node, js, ts, logoReact, mongoDB]}
            lien="https://github.com/DRF-dev/Portfolio"
          />
          <DetailsProjets
            nom="Authentification par JWT"
            images={[node, js, ts, logoReact, mongoDB]}
            lien="https://github.com/DRF-dev/Authentification_jwt"
          />
        </Row>
        <Row className="mt-sm-5">
          <DetailsProjets
            nom="Chat & todo-liste en temps réel"
            images={[node, js, logoReact, socket]}
            lien="https://github.com/DRF-dev/Todo-liste-en-temps-reel"
          />
          <DetailsProjets
            nom="Générateur de fichiers PDF"
            images={[go]}
            lien="https://github.com/DRF-dev/Generateur_pdf"
          />
        </Row>
        <Row className="mt-sm-5">
          <DetailsProjets
            nom="CRUD en CLI"
            images={[go]}
            lien="https://github.com/DRF-dev/CRUD_CLI"
          />
          <DetailsProjets
            nom="Cracking de mot de passe simple"
            images={[py]}
            lien="https://github.com/DRF-dev/Crack_simple_password"
          />
        </Row>
      </div>
    </Container>
