...
const Contact = () => {
  ...
  const envoi = async () => {
    if (name === '' || entreprise === '' || message === '')
      return notif.error("L'un des champs est vide");
      ...
      <div>
        ...
        <Row className="mt-4 ml-3">
          <Col xs={6} sm={4} className="offset-sm-2">
            <a
              href="https://www.linkedin.com/in/dany-francisco-dev-junior/"
              target="_blank"
